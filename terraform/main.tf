...
locals {
  ...
  {
    "CVE_API_KEY" = contains(keys(local.existing_secret), "${local.existing_secret["CVE_API_KEY"]}"),
    "ATLASDB_ALGOREAD" = contains(keys(local.existing_secret), "${local.existing_secret["ATLASDB_ALGOREAD"]}"),
