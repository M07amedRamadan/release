...
# locals {
#   new_user_url = "mongodb+srv://${var.CUSTOMER_NAME}_user:${random_password.db_password.result}@cluster0.ghbhwuc.mongodb.net/${var.CUSTOMER_NAME}_DB?retryWrites=true&w=majority"
